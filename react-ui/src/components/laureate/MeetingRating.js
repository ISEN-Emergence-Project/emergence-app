/**
 * MEETINGS RATING COMPONENT <- LAUREATE MEETING CARD COMPONENT <- LAUREATE MEETINGS LIST PAGE
            ...
            <div className='text-center'>
                {meeting.laureateRating == null ? (
                    <Button className=" align-self-center col"  variant="btn btn-success"
                            onClick={() => updateRating(meeting.fkGodfatherAccountId, note)}>Envoyer</Button>
                ) : (
                    <>
